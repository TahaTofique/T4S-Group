...
export default function Landing() {
  ...
  return (
    <>
      {/* ---------------------------------------------------------------- */}
      {/* HERO — fullscreen, parallax architectural background            */}
      {/* ---------------------------------------------------------------- */}
      <section ref={heroRef} className="relative flex h-screen min-h-[720px] items-center overflow-hidden">
        ...
        <motion.div style={{ opacity }} className="container-max relative px-6 sm:px-10 lg:px-16">
          <Reveal>
            <p className="eyebrow">T4S Group · Est. {companyData.founded}</p>
          </Reveal>
          <Reveal delay={0.1}>
          ...
          <Reveal delay={0.3}>
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a href="/security" className="btn-primary">
                Explore T4S Security
              </a>
              <a href="/enterprises" className="btn-outline">
