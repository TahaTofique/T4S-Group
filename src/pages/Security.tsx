    ...
    <>
      ...
      <section className="relative flex min-h-[85vh] items-center overflow-hidden pt-24">
        <div className="absolute inset-0">
          <img src={data.heroImage} alt={data.name} className="animate-kenburns h-full w-full object-cover" />
        ...
        <div className="container-max relative px-6 sm:px-10 lg:px-16">
          ...
          <Reveal delay={0.3}>
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <Magnetic>
                <a href="#quote" className="btn-primary shine">
                  Request a Quote
                  <ArrowRight size={15} />
                </a>
              </Magnetic>
              <Magnetic>
                <a href="#services" className="btn-outline shine">
                  View Services
                </a>
              </Magnetic>
            </div>
        ...
        <div className="container-max">
          ...
          >
            ...
            <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1.4fr_0.6fr]">
              ...
              <Magnetic>
                <a href="#quote" className="btn-primary shine w-full sm:w-auto">
                  Apply Now
                  <ArrowRight size={15} />
                </a>
              </Magnetic>
